...
//        initArray();
    ...
    public Protocol.Account queryAccount(byte[] address, boolean useSolidity) throws ConnectErrorException {
        try {
    ...
    public GrpcAPI.DelegatedResourceList queryDgList(String fromAddress, String toAddress){
        ...
        if (blockingStubSolidity != null) {
            return blockingStubSolidity.getDelegatedResource(drm);
        } else {
